  ...
  return <div className="w-full min-h-screen flex flex-wrap gap-4 bg-white overflow-hidden">
    ...
    <section className="flex-1 flex justify-center items-center pt-10 px-5 ">
      <div className="space-y-16">
        <h2 className="font-text text-3xl font-medium">Get Started Now</h2>
        {/* sign up local form */}
        ...
        <div>
          ...
          <span className="flex justify-center items-center gap-6 mb-7">
            ...
            >
              ...
              />
              <span className="font-text text-[13px] font-medium text-nowrap" >Sign in with Google</span>
            </button>
            <button
              className="flex-1 flex justify-center items-center gap-3 p-1 border rounded-lg cursor-pointer"
            >
              <img
                src={appleIcon}
                alt="apple icon"
                className="h-6 w-6 object-contain"
              />
              <span className="font-text text-[13px] font-medium text-nowrap">Sign in with Apple</span>
            </button>
          </span>
          {/* option to sign in */}
          <span className="flex justify-center items-center gap-3 font-text text-[15px] font-medium text-nowrap">
    ...
    {/* Add a background image with tailwind css bg-[url()] and other background image design */}
    <section className="flex-1 bg-no-repeat bg-cover bg-center rounded-t-[45px] md:rounded-l-[45px] min-w-[480px] min-h-[480px]" style={{ backgroundImage: `url(${sideImage})` }}>      
    </section>
  </div>;
};
